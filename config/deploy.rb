...
set :application, 'napthe'
set :repo_url, 'git@github.com:anhdayem818/napthe.git'
...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/environments/production.rb', "db/production.sqlite3")
